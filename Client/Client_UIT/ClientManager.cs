                ...
                try
                {
                    ...
                    if (cmt == CommandType_.LoginSuccess)
                    {
                        ...
                        if (_frmMain == null)
                        {
                            dangnhapForm.Invoke(new Action(delegate()
                            {
                                ...
                                {
                                    _frmMain = new Form1(dangnhapForm, this._userName, image, this);
                                    _frmMain.Text = "Talk";
                                    _frmMain.Show();
                                    dangnhapForm.Hide();
                                }
                    ...
                    if(cmt==CommandType_.ListFriend)
                    {
                        ...
                        for (int i = 0; i < _CountTemp; i++)
                        {
                            ...
                            {
                                friendTemp = new FriendList(usernameFriend, _avatarFriend, true);
                            }
                            else
                            {
                               friendTemp = new FriendList(usernameFriend, _avatarFriend, false);
                            }
